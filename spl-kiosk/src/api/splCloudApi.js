...
export default {
    methods: {
        ...
        async getLockerByParcelQrcode(code) {
            return await Vue.axios.get(base_url + "/v1/locker/", { params : { 'qrcode' : code }});
        },
        async getLockerByParcelBarcode(code) {
            return await Vue.axios.get(base_url + "/v1/locker/", { params : { 'barcode' : code }});
        },
        //Sizes
        async getSizes() {
        ...
        async getClientByQrcode(code) {
            return await Vue.axios.get(base_url + "/v1/client/", { params : { 'qrcode' : code }});
        },
        async getClientByBarcode(code) {
            return await Vue.axios.get(base_url + "/v1/client/", { params : { 'barcode' : code }});
        },
